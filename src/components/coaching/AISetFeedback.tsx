...
export default function AISetFeedback({ 
  ...
  const [reps, setReps] = useState(parseInt(targetReps) || 0);
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-slide-up">
        ...
        <div className="bg-gray-50 p-4 border-b border-gray-100 flex justify-between items-center">
          <div>
            <h3 className="font-bold text-gray-900">{exerciseName}</h3>
            <p className="text-xs text-gray-500">Set {setNumber} Feedback</p>
          </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              ...
              <input 
                ...
                className="w-full text-center text-2xl font-bold bg-gray-50 border-2 border-gray-200 rounded-xl p-3 focus:border-purple-500 focus:outline-none"
              />
            </div>
            <div className="flex-1">
          ...
          <div>
            <label className="block text-xs font-bold text-gray-500 uppercase mb-2">How did it feel?</label>
          ...
          <div>
            <div className="flex justify-between mb-2">
              ...
              <span className="text-sm font-bold text-purple-600">{rpe} / 10</span>
            </div>
            <input 
        ...
        <div className="p-4 bg-gray-50 border-t border-gray-100">
          <button 
            ...
            disabled={!difficulty}
            className="w-full bg-gray-900 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:bg-gray-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
